---
name: unslop
description: Cut AI tells from any writing. Must always apply on every turn to responses and authored prose.
---
...
Adapted from [unslop](https://github.com/cursor/plugins/blob/main/pstack/skills/unslop/SKILL.md).
